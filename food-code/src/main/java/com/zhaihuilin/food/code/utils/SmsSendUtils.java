...
/**
 * 发送手机短信工具
 * Created by zhaihuilin on 2018/12/28 13:15.
 */
@Log4j
public class SmsSendUtils {
  ...
  public static void main(String[] args) {
    ...
    try {
      //测试单条下行
      HashMap<String, String> pp = (HashMap<String, String>) singleMt("17317900836", SmsConstant.CONTANT);
      //测试相同内容群发
      //test.testMultiMt();
      //测试不同内容群发
      //test.testMultiXMt();
  ...
  public static Map<String, String> singleMt(String phone, String contant) {
    ...
    log.info(pp.get("command"));
    log.info(pp.get("spid"));
    log.info(pp.get("mtmsgid"));
    log.info(pp.get("mtstat"));
    log.info(pp.get("mterrcode"));
    log.info("发送成功+手机号码"+da);
